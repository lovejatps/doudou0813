...
<div class="container">
    <div class="breadNav">
        <ul class="clear">
            ...
            <li class="bread-home"><a href="javascript:void(0);"><font>&gt;&gt;&nbsp;</font>SN添加</a></li>
        </ul>
    </div>
    <!-- /breadNav -->
    <div class="formBody">
        <div class="form-add clear">
        	<form action="<c:url value='/buzsn/doInputSn.htm'/>" id="normal" method="post">
            <div class="label-form">
                <label class="left-add" for="snvalue">SN：</label>
                <div class="right-add">
                    <input type="text" name="sn.value" id="snvalue" class="inp_r"/>
                    <button class="btn-green">提交</button>
                    <div id="snvalueTip"></div>
                </div>
            </div>
            </form>
            
            <form action="<c:url value='/buzsn/doInputSnFile.htm'/>" id="batch" onsubmit="return myForm.batch();" method="post" enctype="multipart/form-data">
            <div class="label-form">
                <div class="left-add">批量添加：</div>
                <div class="right-add">
                    <input type="file" name="snFile" class="up-file" id="snFile" size="28" onchange="document.getElementById('textfield').value=this.value">
