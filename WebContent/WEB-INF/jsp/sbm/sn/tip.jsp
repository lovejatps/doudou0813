...
<body>
	<div class="container">
		<div class="breadNav">
			<ul class="clear">
				<li class="bread-home"><a href="javascript:void(0);">SN管理操作提示</a></li>
			</ul>
		</div>
		<!-- /breadNav -->
		<div class="successTip">
			<div class="centerTip">
				...
				<p>
					您可以继续 <a href="<c:url value='/buzsn/add.htm'/>">【添加SN信息】</a>，<span
						id="jumpTo">5</span>秒后页面自动回到列表页面
				</p>
				<p>
					<button
						onclick="window.location.href='<c:url value='/buzsn/list.htm'/>'"
