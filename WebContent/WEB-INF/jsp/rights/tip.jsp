...
<div class="container">
    ...
    <div class="successTip">
        <div class="centerTip">
            ...
            <p class="red">信息添加成功</p>
            <p>您可以继续 <a href="<c:url value='/rights/addpage.htm'/>">【添加厂家信息】</a>，<span id="jumpTo">5</span>秒后页面自动回到列表页面</p>
            <p><button onclick="window.location.href='<c:url value='/rights/listpage.htm'/>'" class="btn-green">确定</button></p>
        </div>
    </div>
