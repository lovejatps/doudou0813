		...
		function checkSysPackageModel(id){
			...
			if(str && type && version){
				$.ajax({
					...
					dataType: "json",
					async:false,
					url: "<c:url value='/upgrade/syspackage/checkUpdateSyspackage.htm'/>?modelIds="
							+str+"&type="+type+"&version="+version+"&packId="+${obj.sysPack.id},
            ...
            <div class="label-form">
                ...
                <div class="right-add">
	                ...
	                <div style="float: left;" id="typeValue">
	                	<input type="hidden" name="package.sysVersion" id="packvalue0" class="inp_r" value="${obj.sysPack.sysVersion}"/>
