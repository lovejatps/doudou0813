...
<div class="container">
    <div class="breadNav">
        <ul class="clear">
            <li class="bread-home"><a href="javascript:void(0);">系统包管理操作提示</a></li>
        </ul>
    </div>
    <!-- /breadNav -->
    <c:if test="${obj=='add'}">
    <div class="successTip">
        <div class="centerTip">
            ...
            <p class="red">上传成功</p>
            <p>您可以继续 <a href="<c:url value='/upgrade/syspackage/addPackage.htm'/>">【上传系统包】</a>，<span id="jumpTo">5</span>秒后页面自动回到列表页面</p>
            <p><button onclick="window.location.href='<c:url value='/upgrade/syspackage/listPackage.htm'/>'" class="btn-green">确定</button></p>
        </div>
    </div>
    </c:if>
    <!-- /successTip -->
