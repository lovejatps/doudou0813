...
<div class="container">
    <div class="breadNav">
        <ul class="clear">
            <li class="bread-home"><a href="javascript:void(0);">动画管理操作提示</a></li>
        </ul>
    </div>
    <!-- /breadNav -->
    <c:if test="${obj=='add'}">
    <div class="successTip">
        <div class="centerTip">
            ...
            <p class="red">添加成功 !</p>
            <p>您可以继续 <a href="<c:url value='/upgrade/animation/addAnimation.htm'/>">【动画上传】</a>，<span id="jumpTo">5</span>秒后页面自动回到列表页面</p>
            <p><button onclick="window.location.href='<c:url value='/upgrade/animation/listAnimation.htm'/>'" class="btn-green">确定</button></p>
        </div>
    </div>
    <!-- /successTip -->
    </c:if>
